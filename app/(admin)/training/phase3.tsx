        ...
        <View className="p-5">
            <View className="flex-row items-center justify-between mb-3">
                <View className="flex-row items-center flex-1">
                    <View className={`p-3 rounded-xl mr-3 ${module.type === 'video' ? 'bg-blue-50' : 'bg-pink-50'}`}>
                        {module.type === 'video' ? (
            ...
            <TouchableOpacity className="bg-pink-600 py-3 rounded-xl items-center">
    ...
    const fetchModules = async () => {
        try {
            ...
            if (Array.isArray(data)) {
                const phaseModules = data.filter((m: any) => m.phase === 'Phase 3');
    ...
    return (
        ...
        >
            <View className="relative overflow-hidden mb-6">
                <LinearGradient colors={['#EC4899', '#DB2777']} className="pt-12 pb-16 px-6 rounded-b-[40px]">
                    ...
                    <View className="flex-row items-center mb-6">
                        ...
                        <View className="flex-1">
                            <Text className="text-pink-100 text-sm mb-1">Phase 3</Text>
                            <Text className="text-white text-3xl font-bold">Conquer</Text>
                            <Text className="text-pink-100 text-sm mt-1">Election dominance</Text>
                        </View>
            ...
            <View className="px-4">
                <View className="flex-row mb-6 space-x-3">
                    <View className="flex-1 bg-white rounded-2xl p-4 shadow-sm">
                        <View className="bg-pink-50 p-2 rounded-lg mb-2 self-start">
                ...
                <View className="mb-6">
                    ...
                    {loading && !refreshing ? (
                        ...
                        <Text className="text-gray-400 text-center py-4">No modules found for Phase 3</Text>
                    ) : (
                        modules.map(module => (
