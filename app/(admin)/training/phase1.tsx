...
const ModuleCard = ({ module, onEdit, onDelete }: ModuleCardProps) => (
    <View style={{
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 16 }}>
            <LinearGradient
                colors={module.type === 'video' ? ['#3B82F6', '#2563EB'] : ['#8B5CF6', '#7C3AED']}
                style={{
                    width: 56,
                    height: 56,
                    borderRadius: 16,
            ...
            <View style={{ flex: 1 }}>
                <View style={{
                    backgroundColor: module.type === 'video' ? '#dbeafe' : '#f3e8ff',
                    ...
                    <Text style={{
                        fontSize: 11,
                        fontWeight: '700',
                        color: module.type === 'video' ? '#2563eb' : '#7c3aed',
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 16 }}>
            ...
            <View style={{
                ...
                <Text style={{ fontSize: 12, fontWeight: '600', color: '#059669' }}>{module.phase}</Text>
            </View>
        </View>
        ...
        <View style={{ flexDirection: 'row', gap: 12 }}>
            ...
            >
                ...
                <Text style={{ color: '#4F46E5', fontWeight: '700', fontSize: 14, marginLeft: 8 }}>Edit</Text>
            </TouchableOpacity>
    ...
    const fetchModules = async () => {
        try {
            ...
            if (Array.isArray(data)) {
                const phase1Modules = data.filter((m: any) => m.phase === 'Phase 1');
                setModules(phase1Modules);
            }
        } catch (error) {
            ...
            <View style={{ position: 'relative', overflow: 'hidden', marginBottom: 24 }}>
                ...
                >
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 24 }}>
                        ...
                        <View style={{ flex: 1 }}>
                            <Text style={{ color: '#bfdbfe', fontSize: 14, marginBottom: 4 }}>Phase 1</Text>
                            <Text style={{ color: 'white', fontSize: 28, fontWeight: 'bold' }}>Connect</Text>
                            <Text style={{ color: '#bfdbfe', fontSize: 14, marginTop: 4 }}>Building the network</Text>
                        </View>
            ...
            <View style={{ paddingHorizontal: 16, paddingBottom: 100 }}>
                ...
                <View style={{ flexDirection: 'row', marginBottom: 24, gap: 12 }}>
                    <View style={{ flex: 1, backgroundColor: 'white', borderRadius: 20, padding: 18, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 8, elevation: 2 }}>
                        <View style={{ backgroundColor: '#dbeafe', padding: 10, borderRadius: 12, alignSelf: 'flex-start', marginBottom: 10 }}>
                ...
                <View style={{ marginBottom: 24 }}>
                    ...
                    {loading && !refreshing ? (
                        ...
                        <View style={{ backgroundColor: 'white', padding: 40, borderRadius: 20, alignItems: 'center' }}>
                            ...
                            <Text style={{ color: '#6b7280', fontSize: 16, marginTop: 16, fontWeight: '500' }}>No modules found for Phase 1</Text>
                        </View>
                    ) : (
                        modules.map(module => (
                            <ModuleCard
