    ...
    return (
        ...
        >
            <View className="relative overflow-hidden mb-6">
                <LinearGradient colors={['#3B82F6', '#2563EB']} className="pt-12 pb-16 px-6 rounded-b-[40px]">
                    ...
                    <View className="flex-row items-center mb-6">
                        ...
                        <View className="flex-1">
                            <Text className="text-blue-100 text-sm mb-1">Phase 1</Text>
                            <Text className="text-white text-3xl font-bold">Connect</Text>
                            <Text className="text-blue-100 text-sm mt-1">Building the network</Text>
                        </View>
            ...
            <View className="px-4">
                <View className="flex-row mb-6 space-x-3">
                    <View className="flex-1 bg-white rounded-2xl p-4 shadow-sm">
                        <View className="bg-blue-50 p-2 rounded-lg mb-2 self-start">
                ...
                <View className="mb-6">
                    ...
                    {loading && !refreshing ? (
                        ...
                        <Text className="text-gray-400 text-center py-4">No modules found for Phase 1</Text>
                    ) : (
                        modules.map(module => (
