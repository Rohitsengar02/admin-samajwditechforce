...
export default function CreateEvent() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (!token) {
                showAlert('Error', 'You are not logged in. Please login again.');
                return;
            }
            ...
            if (response.status === 401) {
                showAlert('Unauthorized', 'Your session has expired or you don\'t have admin privileges. Please login again.', () => {
